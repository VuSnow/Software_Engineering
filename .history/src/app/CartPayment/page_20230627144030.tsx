          ...
          <div className="deli-information py-0 px-5 ml-auto">
            ...
            <div className="customer-info w-full">
              ...
              <div className="select-city w-full flex flex-wrap p-0 float-none relative">
                <div className="city w-1/3 relative box-border align-top min-h-[1px] mx-0 p-[10px] w-full">
                  <select
                    name="city"
                    id="city"
                ...
                <div className="district w-1/3 relative box-border align-top min-h-[1px] mx-0 p-[10px] w-full">
                  <select
                    name="district"
                    id="district"
                    className="form-select"
                ...
                <div className="ward w-1/3 relative box-border align-top min-h-[1px] mx-0 p-[10px] w-full">
