                  ...
                  <div className="cart-item-right flex-[3] mr-6">
                    <div className="cart-item-block flex flex-wrap h-full">
                      ...
                      <div className="cart-item-action flex flex-col w-full mt-auto flex-wrap">
                        <div className="flex">
                          <div className="color-select text-[.7rem] inline-block box-border relative">
                            <select
                              name="color"
                              id="color"
                              className="inline-flex py-[3px] px-[6px] h-[30px] rounded-lg border border-solid border-black"
                            >
