          ...
          <div className="deli-information py-0 px-5 ml-auto">
            ...
            <div className="customer-info w-full">
              <div className="name w-full flex flex-wrap p-0 float-none relative">
                <div className="name-input flex-[1] relative box-border align-top min-h-[1px] mx-0 ">
                  <input
                    type="text"
                    name="full_name"
                ...
                <div className="number-input flex-[1] relative box-border align-top min-h-[1px] mx-0 ">
                  <input
                    type="tel"
                    name="phone"
