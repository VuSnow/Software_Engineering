              ...
              <div className="select-city w-full flex flex-wrap p-0 float-none relative">
                <div className="city flex-[1] relative box-border align-top min-h-[1px] mx-0 p-[10px]">
                  <select
                    name="city"
                    id="city"
                    className="form-select bg-[#fff] border border-solid border-[#d9d9d9] box-border rounded-2xl h-10 w-full py-[5px] px-5 duration-200 ease-in-out delay-0 transition-all"
                ...
                <div className="district flex-[1] relative box-border align-top min-h-[1px] mx-0 p-[10px] pr-5">
                  <select
                    name="district"
                    id="district"
                    className="form-select bg-[#fff] border border-solid border-[#d9d9d9] box-border rounded-2xl h-10 w-full py-[5px] px-5 duration-200 ease-in-out delay-0 transition-all"
