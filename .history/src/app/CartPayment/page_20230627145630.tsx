          ...
          <div className="payment-method py-0 px-5 ml-auto">
            ...
            <div className="form-container">
              <form action="">
                <label
                  htmlFor="payment-COD"
                  className="mb-4 flex items-center rounded-2xl py-[15px] px-5 cursor-pointer duration-200 ease-in-out delay-0 transition-all"
                >
                  <span className="block relative grow-0 shrink-0 basis-5 w-5 h-5 rounded-full duration-200 ease-in-out delay-0 transition-all">
                    <input
                      ...
                      value="COD"
                    />
                    <span className="checkmark absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[10px] h-[10px] rounded-[20px] bg-[#2f5acf]"></span>
                  </span>
                  <span>
                ...
                <label
                  ...
                  className="flex items-center rounded-2xl py-[15px] px-5 cursor-pointer duration-200 ease-in-out delay-0 transition-all"
                >
                  <span className="block relative grow-0 shrink-0 basis-5 w-5 h-5 rounded-full duration-200 ease-in-out delay-0 transition-all">
                    <input
                      type="radio"
