      ...
      <div className="mt-10">
        <div className="categories-list">
          <div className="tab-header flex mb-5">
            <Link
              href="#"
              className="w-[100px] h-12 bg-[#ccc] flex items-center justify-center flex-col big-desktop:min-w-[100px] rounded-[41px] text-center text-sm my-0 mx-2 font-semibold py-[10px] px-3 flex-wrap-[initial] cursor-pointer "
            >
              All
            </Link>
            <Link
