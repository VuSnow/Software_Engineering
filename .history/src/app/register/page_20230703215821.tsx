...
const Register = ({
  ...
  return (
    <div className="registerModal fixed w-full h-full top-0 left-0 z-[150]">
        ...
        <div>
          <div className="form-container">
            <form id="register-form">
              <div className="register-heading mb-4 text-center">
              ...
              <button className="register-btn block rounded-2xl h-10 w-full py-[5px] px-5 bg-black text-white text-center border-0 cursor-pointer transition-all delay-0 duration-200 ease-in-out mt-4">
                Đăng ký
              </button>
              ...
              <div className="auth-action flex justify-center items-center">
                <a
                  href="#"
