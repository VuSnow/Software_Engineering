      ...
      <div className="search-container max-w-7xl w-full my-0 mx-auto">
        <div className="homepage-wrapper flex justify-center flex-col my-0 mx-auto max-w-[700px] items-center">
          ...
          <div className="homepage-search-inner relative w-full">
            ...
            <div className="homepage-search-spotlight absolute bg-white shadow-[0_0_10px_0_#aebbc1] p-4 rounded-lg w-full max-w-[500px] left-1/2 top-full z-10 translate-x-[-50%] translate-y-0 transition-all duration-300 delay-0 mt-3 hidden invisible">
