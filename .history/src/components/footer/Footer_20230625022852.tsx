...
const Footer = () => {
  return (
    <footer className="text-white flex justify-center items-center bg-black py-[30px] px-0 leading-[160%] mt-8">
      <div className="container  w-full">
        <div className="footer-top text-sm">
          <div className="top-sidebar flex justify-between items-center gap-[8%] mb-8 w-full">
            ...
            <div className="social mt-0 pr-10 h-[130px] flex justify-center items-center">
              <div>
                <Link href="https://www.facebook.com/dung.vuminh.315080/">
                  <Image src={facebookIcon} alt="" className="h-full w-full" />
                </Link>
              </div>
              <div>
                <Link href="https://www.instagram.com/v.m.dung.36/">
                  <Image src={instaIcon} alt="" className="h-full w-full" />
                </Link>
              </div>
              <div>
                <Link href="https://zalo.me/0366032936">
                  <Image src={zaloIcon} alt="" className="h-full w-full" />
                </Link>
              </div>
            </div>
          </div>
