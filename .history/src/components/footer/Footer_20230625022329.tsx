          ...
          <div className="top-sidebar flex justify-between items-center gap-[8%] mb-8 w-full">
            ...
            <div className="social mt-0 pr-10 h-[130px] flex justify-center items-center">
              <Link
                ...
                className=""
              >
                <Image src={facebookIcon} alt="" className="h-12 w-12" />
              </Link>
              <Link href="https://www.instagram.com/v.m.dung.36/" className="">
                <Image src={instaIcon} alt="" className="h-12 w-12" />
              </Link>
              <Link href="https://zalo.me/0366032936" className="">
                <Image src={zaloIcon} alt="" className="h-12 w-12" />
              </Link>
            </div>
          </div>
