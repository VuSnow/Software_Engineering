...
const Footer = () => {
  return (
    <footer className="text-white flex justify-center items-center bg-black w-screen">
      <div className="container w-full">
        <div className="footer-top w-full">
          <div className="top-sidebar flex justify-between items-start gap-[8%] mb-8 w-full">
            <div>
              <h4>Fashion Store</h4>
            ...
            <div>
              <div className="hotline flex gap-8 items-center w-fit">
                <div className="icon">
              ...
              <div className="email flex gap-8 items-center w-fit">
                <div className="icon">
