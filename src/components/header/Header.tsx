...
const Header = () => {
  ...
  return (
    <>
      <header className="text-black shadow-sm  mb-4 fixed block top-0 left-0 right-0 bg-white w-full shadow-gray-500 z-[99]">
        <div className="flex tablet: justify-between h-20 items-center mr-auto ml-auto max-w-full pl-[5%] pr-[5%]">
          ...
          <div className="logo-brand">
            <a href="#" className="text-[50px] font-bold font-kumbhsan">
              Fashion
            </a>
          </div>
          <div className="right-header flex">
            ...
            <div className="header-action flex">
              ...
              <div className="item person m-[10px] max-mobile:hidden cursor-pointer">
